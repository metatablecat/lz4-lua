...
local Tests = {
	...
	["weird edgecase 1 - this one C chunk cant be recompressed"] = function()
		local data = "\x19\x00\x00\x00\x17\x00\x00\x00\x00\x00\x00\x00\xF0\x08\x00\x00\x00\x00\x06\x00\x00\x00\x46\x6F\x6C\x64\x65\x72\x00\x01\x00\x00\x00\x00\x00\x00\x00"
		local d = lz4.decompress(data)
		print(d == "\x00\x00\x00\x00\x06\x00\x00\x00\x46\x6F\x6C\x64\x65\x72\x00\x01\x00\x00\x00\x00\x00\x00\x00") --ensuring it can be decompressed
		local c = lz4.compress(d)
